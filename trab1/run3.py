...
for argv in sys.argv[1:]:
    ...
    for s in range(k):
        ...
        shakes1_3_2_4.append(Permutation(size,p))
        shakes1.append(Permutation(size,p1))
        shakes2.append(Permutation(size,p2))
        shakes3.append(Permutation(size,p3))
        shakes4.append(Permutation(size,p4))    
        shakes1_2.append(Permutation(size,p1_2))
        shakes1_3.append(Permutation(size,p1_3))
        shakes1_4.append(Permutation(size,p1_4))
        shakes2_3.append(Permutation(size,p2_3))
        shakes2_4.append(Permutation(size,p2_4))
        shakes3_4.append(Permutation(size,p3_4))
    ...
    print "first LS only: %s" % maxima

    if _debug>0: print "starting ILS"

    print "shake 1"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes1)
    _stop = time.time()
    ...
    print "shake 2"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes2)
    _stop = time.time()
    ...
    print "shake 3"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes3)
    _stop = time.time()
    ...
    print "shake 4"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes4)
    _stop = time.time()
    ...
    print "shake 1->2"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes1_2)
    _stop = time.time()
    ...
    print "shake 1->3"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes1_3)
    _stop = time.time()
    ...
    print "shake 1->4"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes1_4)
    _stop = time.time()
    ...
    print "shake 2->3"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes2_3)
    _stop = time.time()
    ...
    print "shake 2->4"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes2_4)
    _stop = time.time()
    ...
    print "shake 3->4"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes3_4)
    _stop = time.time()
    ...
    print "shake 1->3->2->4"
    _start = time.time()
    i_out = ils(_instance,maxima['order'],shakes1_3_2_4)
    _stop = time.time()
